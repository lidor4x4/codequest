  ...
  useEffect(() => {
    const getMessages = async (ID) => {
      ...
      conversationSnapshot
        .where('users', 'array-contains', userIDEffect)
    ...
    <>
      ...
      {loading ? (
        ...
        <div className='flex flex-col justify-center items-center'>
          <h1 className='text-2xl mt-4 text-center sm:text-left'>
            Chat with{' '}
          ...
          <div className='mx-auto'>
              ...
              return (
                <div
                  className={`flex flex-col ${
                    isUserMessage ? 'justify-start items-start mx-4 sm:ml-4 sm:mr-4' : 'justify-end items-end mx-4 sm:ml-4 sm:mr-4'
                  }`}
                  key={index}
                >
            ...
            <div className='flex flex-row justify-center items-center my-6 gap-4' ref={bottomRef}>
              <Alert className={`visible sm:invisible`}>{error}</Alert>
